// var web3 = new Web3();
var web3 = new Web3('ws://localhost:7545'); // 가나슈에 접속
...
var contractAddress = '0x4d03D10c71F4f821d163fd6dA2b9FB81c8a37F21';
// var auction = auctionContract.at(contractAddress); 
auctionContract.options.address = '0x4d03D10c71F4f821d163fd6dA2b9FB81c8a37F21';

function bid() {
	
	var mybid = document.getElementById('value').value;
	alert("bfvujsbfvg");
	auctionContract.methods.bid().send({from: '0xAEA0ccfaEFcD9358c4600495DE7Cb468083721f4', value: web3.utils.toWei(mybid, "ether"), gas: 200000}).then((result)=>{
  	console.log(result)
  // 
