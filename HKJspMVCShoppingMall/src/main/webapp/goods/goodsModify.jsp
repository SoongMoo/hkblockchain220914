...
<table border=1>
	...
	<tr><th>제조사</th><td><input type="text" name="company" value="${dto.company }" required="required"/></td></tr>
	...
	<tr><th>마지막 수정일</th><td><input type="date" name="goodsUpdate" value="${dto.goodsUptDate }" readonly="readonly"/></td></tr>
