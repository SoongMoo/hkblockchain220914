...
<table border=1>
	<tr><td>직원번호</td><td><input type="text" name="employeeNum" value="${employeeNum }" readonly="readonly"/>번호자동부여</td></tr>
	...
	<tr><td>직원입사일</td><td><input type="date" name="hireDate" /></td></tr>	
